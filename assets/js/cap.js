      ...
      if (user) {
        ...
        rightSideNav.innerHTML += `
                ...
                <a href="cart.html" id="cart-icon">
                    <img src="/assets/images/cart-icon.png" alt="Cart" class="cart-icon" title="Cart">
                </a>
...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    const querySnapshot = await getDocs(collection(db, "cap"));
    querySnapshot.forEach((doc) => {
        ...
        const bagContainer = document.getElementById("cap-cont");
...
document.getElementById("sortPrice").addEventListener("change", function () {
    ...
    let container = document.getElementById("cap-cont");
